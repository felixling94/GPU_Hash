...
int main(){
    ...
    Example_Hash_Table<uint32_t> example_hash_table1(num_threads_per_block,block_num,exampleHashTableSize,modulo);
    ...
    Example_Hash_Table<uint32_t> example_hash_table2(num_threads_per_block,block_num,exampleHashTableSize,multiplication);
    ...
    Example_Hash_Table<uint32_t> example_hash_table3(num_threads_per_block,block_num,exampleHashTableSize,murmer);
    ...
    Example_Hash_Table<uint32_t> example_hash_table4(num_threads_per_block,block_num,exampleHashTableSize,universal0);
    ...
    Example_Hash_Table<uint32_t> example_hash_table5(num_threads_per_block,block_num,exampleHashTableSize,universal1);
    ...
    Example_Hash_Table<uint32_t> example_hash_table6(num_threads_per_block,block_num,exampleHashTableSize,universal2);
    ...
    Example_Hash_Table<uint32_t> example_hash_table7(num_threads_per_block,block_num,exampleHashTableSize,dycuckoo_hash1);
    ...
    Example_Hash_Table<uint32_t> example_hash_table8(num_threads_per_block,block_num,exampleHashTableSize,dycuckoo_hash2);
    ...
    Example_Hash_Table<uint32_t> example_hash_table9(num_threads_per_block,block_num,exampleHashTableSize,dycuckoo_hash3);
    ...
    Example_Hash_Table<uint32_t> example_hash_table10(num_threads_per_block,block_num,exampleHashTableSize,dycuckoo_hash4);
    ...
    Example_Hash_Table<uint32_t> example_hash_table11(num_threads_per_block,block_num,exampleHashTableSize,dycuckoo_hash5);
