...
int main(){
    ...
    Example_Hash_Table<uint32_t> example_hash_table1(exampleKeyNum,exampleHashTableSize,modulo,modulo,
    ...
    Example_Hash_Table<uint32_t> example_hash_table2(exampleKeyNum,exampleHashTableSize,multiplication,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table3(exampleKeyNum,exampleHashTableSize,murmer,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table4(exampleKeyNum,exampleHashTableSize,universal0,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table5(exampleKeyNum,exampleHashTableSize,universal1,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table6(exampleKeyNum,exampleHashTableSize,universal2,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table7(exampleKeyNum,exampleHashTableSize,dycuckoo_hash1,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table8(exampleKeyNum,exampleHashTableSize,dycuckoo_hash2,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table9(exampleKeyNum,exampleHashTableSize,dycuckoo_hash3,modulo,
                                                     num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table10(exampleKeyNum,exampleHashTableSize,dycuckoo_hash4,modulo,
                                                      num_threads_per_block,block_num);
    ...
    Example_Hash_Table<uint32_t> example_hash_table11(exampleKeyNum,exampleHashTableSize,dycuckoo_hash5,modulo,
                                                      num_threads_per_block,block_num);
