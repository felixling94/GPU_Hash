...
int main(){
    ...
    example_hash1.compare_host_device(modulo,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    //Multiplikative Methode
    /////////////////////////////////////////////////////////////////////////////////////////
    Example_Hash<uint32_t>  example_hash2(example_array_size,example_table_size);
    example_hash2.createKeys();
    example_hash2.compare_host_device(multiplication,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    example_hash3.compare_host_device(universal0,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    example_hash4.compare_host_device(universal1,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    example_hash5.compare_host_device(universal2,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    example_hash6.compare_host_device(universal3,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    //Murmer-Hashfunktion
    /////////////////////////////////////////////////////////////////////////////////////////
    Example_Hash<uint32_t>  example_hash7(example_array_size,example_table_size);
    example_hash7.createKeys();
    example_hash7.compare_host_device(murmer,num_threads_per_block,block_num);
    ...
    example_hash8.compare_host_device(dycuckoo_hash1,num_threads_per_block,block_num);
    ...
    example_hash9.compare_host_device(dycuckoo_hash2,num_threads_per_block,block_num);
    ...
    example_hash10.compare_host_device(dycuckoo_hash3,num_threads_per_block,block_num);
    ...
    example_hash11.compare_host_device(dycuckoo_hash4,num_threads_per_block,block_num);
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    example_hash12.compare_host_device(dycuckoo_hash5,num_threads_per_block,block_num);
