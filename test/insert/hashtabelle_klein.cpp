...
int main(int argc, char** argv){
  ...
  Test_Sequentiell<uint32_t,uint32_t> Test_Sequentiell(usrMaxSchluessel,usrMaxSchluessel,usrGroesseSchluessel,usrGroesseHashtabelle);
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
  Test_Sequentiell.insert_hashtabelle(keine_aufloesung,murmer,true);
  /////////////////////////////////////////////////////////////////////////////////////////
  //Lineare Hashverfahren
  /////////////////////////////////////////////////////////////////////////////////////////
  Test_Sequentiell.insert_hashtabelle(linear_aufloesung,murmer,true);
  /////////////////////////////////////////////////////////////////////////////////////////
  //Quadratische Hashverfahren
  /////////////////////////////////////////////////////////////////////////////////////////
  Test_Sequentiell.insert_hashtabelle(quadratisch_aufloesung,murmer,true);
